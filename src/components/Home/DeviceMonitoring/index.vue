...
<script>
    ...
    export default {
        ...
        methods:{
             //图表响应式处理（未启用）
            resizeHandle(){
                document.getElementById('home-temperature-device-monitoring').resize()
                document.getElementById('home-humidity-device-monitoring').resize()
                document.getElementById('home-Acceleration-device-monitoring').resize()
                document.getElementById('home-Illumination-device-monitoring').resize()
            },
        },
        computed:{
